...
| Module 06 | Data Analysis, EDA, Statistics, Python & SQL, DuckDB, Datasette, Geospatial & Network Analysis | Completed |
| Module 07 | Data Visualization, Storytelling, Seaborn, RAWGraphs, Excel, Animation, Network & AI Visualization | Completed |
---
...
| Week 7 | Created data visualizations using tools such as Excel, Seaborn, and RAWGraphs, including charts for trends, distributions, and correlations. Built animated and network visualizations using Flourish and Kumu, and developed interactive notebooks with Marimo. Applied data storytelling techniques and leveraged AI tools to generate and communicate insights effectively. |
